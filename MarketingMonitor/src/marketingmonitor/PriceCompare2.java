 ...
 * @author eoire
 */
public class PriceCompare2 extends javax.swing.JFrame {

    /**
     * Creates new form Login2
     */
    public PriceCompare2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jAdSearchPanel.setBackground(new java.awt.Color(64, 43, 100));
        jAdSearchPanel.setPreferredSize(new java.awt.Dimension(270, 39));
     ...
     public static void AdSearchScreen() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PriceCompare2().setVisible(true);
            }
        });
    }   
